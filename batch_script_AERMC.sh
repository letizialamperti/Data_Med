...
srun -ul $HOME/miniconda3/envs/zioboia/bin/python Data_Med/setup_AERMC.py -u "${args}"
srun -ul $HOME/miniconda3/envs/zioboia/bin/python Data_Med/setup_med_2020.py -u "${args}"
